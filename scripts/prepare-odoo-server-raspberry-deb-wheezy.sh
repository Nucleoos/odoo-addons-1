#!/bin/bash
# Mit diesem Skript werden alle Pakete für den Odoo Betrieb unter Debian Wheezy for Raspberry installiert
# With this script, all packages for ODOO operation under Debian Wheezy for Raspberry will be installed
# Skript muss mit root-Rechten ausgeführt werden also vorher sudo su eingeben!
# ATTENTION YOU NEED TO PROMPT Y (yes) IN CAPITAL LETTER!
##############################################################################
#
#    Shell Script for Odoo, Open Source Management Solution
#    Copyright (C) 2014-now Equitania Software GmbH(<http://www.equitania.de>).
#    some adaption to Raspberry Pi Wheezy from codoo.org
...
if [ "$mypdf" = "Y" ]; then
  echo "HTML2PDF will be install. (OLD VERSION)"
